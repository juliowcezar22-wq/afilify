...
import { paraMotor } from "@/lib/ritmo";
  ...
  try {
    ...
    if (acao === "editar") {
      await atualizarAutomacao(id, {
        ...
        // A tela fala HH:MM; o motor lê decimal. A conversão é na borda, e
        // a validação junto: janela invertida ou campo vazio não chega ao banco.
        ritmo: ritmo === undefined ? undefined : paraMotor(ritmo),
        mensagem,
      });
